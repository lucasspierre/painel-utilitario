...
function dataOutPdf() {
    ...
    if ("" === url) {
        ...
        return document.getElementById("pdfdocout").innerHTML = '<div class="container-md" style="text-align: justify;"><div class="row"><div class="col"><img class="rounded mx-auto d-block" style="max-width: 100%; height: 365;" src="' + url + '"></div><div class="col"><img class="rounded mx-auto d-block" style="max-width: 100%; height: 365;" src="' + url2 + '"></div></div>' + conteudo + '</div>'
        ///tres imagens
    } else if ("" !== url2 && url !== "" && "" !== url3 && "" === url4) {
